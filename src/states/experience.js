export const workExperience = [
  {
    ...
    company: null,
    roles: [
      "Took this Covid-enforced Sabbatical to Study",
      "Learned React (both classes and Hooks)",
      "Revised NodeJS concepts",
      "Used a project-based approach to keep improving"
    ]
  },
  {
    id: 2,
...

  {
    ...
    roles: [
      ...
      "Lesson planning",
      "Creation of personalized assessments",
      "Translation of corporate documents, memorandums, e-mails, legal texts, contracts, letters, minutes of the meeting of the board of directors engineering manuals, technical documentation"
    ]
  }
];
